...
- (void)viewDidLoad {
    ...
    my_arr = @[@"推送",@"键盘通知",@"时间选择器",@"帅比",@"……",@"模态动画",@"核心动画",@"跳转嵌套",@"user跳转嵌套",@"block练习",@"拖动btn",@"CELL滑动删除",@"仿365",@"日历提醒",@"充值吧",@"myColection",@"闪购",@"CellViewController"];
...
//                [self.navigationController pushViewController:qiantao animated:YES];
            ...
            case 16:{
                ...
                break;
            case 17:{
                CellViewController *ceshi = [[CellViewController alloc] init];
                [self.navigationController pushViewController:ceshi animated:YES];
